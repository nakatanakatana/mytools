module github.com/nakatanakatana/mytools/cmd/litestream-vfs-wrapper/example/consumer

go 1.26.3

require (
	github.com/benbjohnson/litestream v0.5.16
	github.com/nakatanakatana/mytools v0.8.0
...
replace github.com/nakatanakatana/mytools => ../../../..
